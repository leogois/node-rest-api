...
const { AuthenticationError, AuthorizatioError } = require('../errors')
...
const updateUser = async (req, res) => {
  ...
  if (id !== req.auth.id) throw new AuthorizatioError('You are not authorized to update this user')
  const body = req.body
...
const deleteUser = async (req, res) => {
  const id = parseInt(req.params.id)
  if (id !== req.auth.id) throw new AuthorizatioError('You are not authorized to delete this user')
